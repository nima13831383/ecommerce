        ...
        <section class="auth-card" aria-labelledby="register-title">
            ...
            <form class="auth-form" method="POST" action="{{ route('register') }}">
                ...
                <label class="auth-field" for="password">رمز عبور
                    <span class="auth-input-wrap password-wrap"><input id="password" name="password" type="password" required autocomplete="new-password"><button class="password-toggle" type="button" data-password-toggle aria-controls="password">◉</button></span>
                </label>
